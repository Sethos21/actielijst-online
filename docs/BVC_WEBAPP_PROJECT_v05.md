...
**Dit is v05.** Vervangt v04: het laatste bekende backlog-item uit Sprint 6 (toekomstige Huurdersmutaties visueel onderscheiden) is afgerond, waarmee de functionele basisscope van de React-rebuild compleet is. Verder ongewijzigd t.o.v. v04 — zie dat document voor de volledige overstap-toelichting van het single-file HTML/localStorage-prototype naar de React + Firebase-webapp.
...
- **Toekomstig jaar visueel onderscheiden** — **gebouwd**: maandblokken van een jaar na het huidige kalenderjaar tonen een gedempte "Toekomstig"-badge naast de maandnaam (`isToekomstigJaar()` in `mutatieLogica.ts`)
...
- Due → amber
- Huurdersmutaties: ingaand → groen, vertrekkend → rood, toekomstig jaar → gedempt grijs
...
- [x] Huurdersmutaties: toekomstige mutaties (2027+) visueel onderscheiden

**Hiermee is de functionele basisscope uit v03/v04 volledig gebouwd.** Wat overblijft is polish/bugfixes na gebruik door het team, geen nieuwe schermen.
...
| `docs/BVC_WEBAPP_PROJECT_v05.md` | Dit document |
...
**Versiebeheer van dit document:** elke inhoudelijke bijwerking krijgt een nieuw versienummer (v05, v06, ...) — nooit overschrijven, nieuw bestand in `docs/` toevoegen. Oude versies mogen blijven staan als historie (ze staan toch al onder git-versiebeheer).
